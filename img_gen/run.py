...
parser.add_argument("--network_capacity", default=8, type=int, help="Network capacity")
parser.add_argument("--fmap_max", default=512, type=int, help="Max style vector dimension")
parser.add_argument("--cls", default=1, type=int, help="Output channel, gli is 3, mri is 1")
parser.add_argument("--style_depth", default=8, type=int, help="Style mapping network depth")
parser.add_argument("--task", default="mri_gen", type=str, help="gli_gen or gli_edit or mri_gen")
...
# Losses
parser.add_argument("--l2_lambda", default=0.1, type=float, help="L2 loss weight for image generation")
parser.add_argument("--percep_lambda", default=0.0, type=float, help="Perceptural loss weight for all tasks")
parser.add_argument("--dice_lambda", default=0.0, type=float, help="Dice loss weight for glioma related tasks")
parser.add_argument("--adv_lambda", default=1.0, type=float, help="Adversarial loss weight for all tasks")
...
# Destination
parser.add_argument("--logdir", default="/home/qlc/train_log/img_gen_5_6", type=str, help="directory to save the tensorboard logs")
