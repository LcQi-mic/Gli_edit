...
class BraTsDatasetEdit(Dataset):
    def __init__(self, data_list, phase='train', modality='t1c'):
        super(BraTsDataset, self).__init__()
        self.data_list = data_list[phase]
...
if __name__ == "__main__":
    train_file_path = './Brats2023/ag_2d/ag_t1_train.json'
    # val_file_path = './Brats2023/ag_2d/ag_t1_val.json'
    # test_file_path = './Brats2023/ag_2d/ag_t1_test.json'
