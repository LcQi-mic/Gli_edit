...
parser.add_argument("--task", default="gli_gen", type=str, help="gli_gen or gli_edit or mri_gen")
parser.add_argument("--attn_layers", default=[0,1,2,3], type=list, help="Attention layers")
...
parser.add_argument("--adv_lambda", default=0.3, type=float, help="Adversarial loss weight for all tasks")

# Data
parser.add_argument("--workers", default=8, type=int, help="number of workers")
parser.add_argument("--batch_size", default=16, type=int, help="number of batch size")
parser.add_argument("--modality", default='t1c', type=str)
parser.add_argument("--data_json", default='/home/qlc/raid/dataset/Brats2023/ag/gli_gen.json', type=str, help="dataset json file")
...
# Destination
parser.add_argument("--logdir", default="/home/qlc/train_log/gli_gen", type=str, help="directory to save the tensorboard logs")
